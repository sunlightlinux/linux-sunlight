...
u8   __read_mostly sched_burst_exclude_kthreads = 0;
...
void __init sched_bore_init(void) {
	...
	printk(KERN_INFO "BORE (Burst-Oriented Response Enhancer) CPU Scheduler aligned %s by Ionut Nechita", SCHED_BORE_VERSION);

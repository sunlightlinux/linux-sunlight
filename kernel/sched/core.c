...
#ifdef CONFIG_SCHED_BORE
	sched_init_bore();
	printk(KERN_INFO "BORE (Burst-Oriented Response Enhancer) CPU Scheduler modification 4.1.7 by Masahito Suzuki");
	printk(KERN_INFO "BORE (Burst-Oriented Response Enhancer) CPU Scheduler aligned 4.1.7 by Ionut Nechita");
#endif // CONFIG_SCHED_BORE

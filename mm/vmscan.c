...
u64 sysctl_anon_min_ratio_kb  __read_mostly = 0;
u64 sysctl_clean_low_ratio_kb __read_mostly = 0;
u64 sysctl_clean_min_ratio_kb __read_mostly = 0;
u64 workingset_protection_prev_totalram __read_mostly = 0;

inline void prepare_workingset_protection(pg_data_t *pgdat, struct scan_control *sc);
